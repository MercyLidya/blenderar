...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getSceneAnimFrameRate, getSceneByAction, AudioWebAudio,
    };
};
...
}, function(event) {}, 'G1ye9@dbVWAx+dC?wdwk');
...
}, function(event) {}, 'zs{d~:/oJ6OM9r)o6R,C');
...
}, function(event) {}, 'WLYxwe*;^db}c?brtmU5');
...
changeVis(['GROUP', 'indicator_group'], false);
changeVis(['drag_move', 'drag_rotate', 'drag_scale', 'scale_percentage', 'ready_button'], false);
operateAnimation('PLAY', 'farmer_armature', 1, 100, 'LoopRepeat', 1, function() {}, false);
volume(loadMedia_WebAudio('sounds/saying_hello.mp3'), 0.6);
registerOnClick('farmer_mesh', false, false, [0,1,2], false, function(event) {
    ...
    operateAnimation('PLAY', 'farmer_armature', 101, 140, 'LoopOnce', 1, function() {
        operateAnimation('PLAY', 'farmer_armature', 1, 100, 'LoopRepeat', 1, function() {}, false);
    }, false);
}, function(event) {});
